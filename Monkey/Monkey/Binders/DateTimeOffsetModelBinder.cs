...
namespace Monkey.Binders
{
    public static class DateTimeOffsetModelBinderExtensions
    {
        public static IServiceCollection AddDateTimeOffsetBinder(this IServiceCollection services)
        {
            ...
            {
                var isProviderAdded = options.ModelBinderProviders.Any(x => x.GetType() == typeof(DateTimeOffsetModelBinderProvider));
    ...
    public class DateTimeOffsetModelBinderProvider : IModelBinderProvider
    {
        public IModelBinder GetBinder(ModelBinderProviderContext context)
        {
            ...
            return context.Metadata.UnderlyingOrModelType == typeof(DateTimeOffset) ? new DateTimeOffsetModelBinder() : null;
        }
    }
            ...
            try
            {
                ...
                if (model == null && !bindingContext.ModelMetadata.IsReferenceOrNullableType)
                {
                    bindingContext.ModelState
                        .TryAddModelError(bindingContext.ModelName, bindingContext.ModelMetadata.ModelBindingMessageProvider.ValueMustNotBeNullAccessor(valueProviderResult.ToString()));
